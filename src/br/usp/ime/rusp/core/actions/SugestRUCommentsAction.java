...
public class SugestRUCommentsAction extends BasicAction {

	private DataRecover<RemoteRecommendation> dataRecover;
	
	public SugestRUCommentsAction(Context context,
	...
	public synchronized void start() {
		...
		try {
			...
			List<RemoteRecommendation> data = connection.getRURecommendations(this.backListener);
