...
public class GetCommentsAction extends BasicAction {

	private DataRecover<RemoteComment> dataRecover;
	
	public GetCommentsAction(Context context,
	...
	public void getComments(DataRecover<RemoteComment> dataRecover) {
	...
	public synchronized void start() {
		...
		try {
			...
			List<RemoteComment> data = connection.getComments(this.backListener);
