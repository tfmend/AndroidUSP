...
public class SugestTimeCommentsAction extends BasicAction {

	private DataRecover<RemoteRecommendation> dataRecover;
	
	public SugestTimeCommentsAction(Context context,
	...
	public synchronized void start() {
		...
		try {
			...
			List<RemoteRecommendation> data = connection.getTimeRecommendation(this.backListener);
