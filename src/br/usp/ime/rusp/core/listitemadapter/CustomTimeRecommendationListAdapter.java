...
public class CustomTimeRecommendationListAdapter extends ArrayAdapter<RemoteRecommendation> {
	...
	public CustomTimeRecommendationListAdapter(Context context,
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if ( !itens.isEmpty() ) {
	        ...
	        String sdescription = item.fila.getFriendlyName() + " - " + item.time; 
